...
{
    public static class XerKeyboardKeys
    {
        #region Fields

        /// <summary>
        /// Character pair class that holds normal char and char with
        /// shift key pressed.
        /// </summary>
        class CharPair
        {
        ...
        /// <summary>
        /// Converts specified key into the required string for processing.
        /// </summary>
        /// <param name="key">Key object to be processed.</param>
        /// <param name="shiftKeyPressed">Boolean describing whether shift is also pressed.</param>
        /// <param name="character">Char output variable.</param>
        /// <returns>Returns true when a character is assigned to the output variable.</returns>
        public static bool KeyToString(Keys key, bool shiftKeyPressed, out char character)
        {
            ...
            {
                // Use it as if it is an A~Z char or space.
